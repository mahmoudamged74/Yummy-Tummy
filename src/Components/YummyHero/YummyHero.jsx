...
import styles from "./YummyHero.module.css";

export default function YummyHero() {
  return (
    <section className={styles.yummyHeroSection}>
        ...
        <div className={`row ${styles.row}`}>
          ...
          <div className="col-12 col-lg-6">
            <div className={styles.rotatingImageContainer}>
              ...
              />
              <h2 className={styles.yummyTitle}>YUMMY TUMMY</h2>
            </div>
          </div>
            ...
            <div className={styles.gridContainer}>
              ...
              >
                <div className={styles.detailsContent}>
                  <p className={styles.detailsText}>DETAILS OF PRODUCT</p>
                  <img
                    src="/assets/plus.svg"
                    alt="Plus Icon"
